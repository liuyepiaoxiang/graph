...
function timelineTransform(data = testData) {
  ...
  const maxDate = new Date(d3.max([...timeMap.values()]));
  const minDate = new Date(d3.min([...timeMap.values()]));
...
export default timelineTransform;
